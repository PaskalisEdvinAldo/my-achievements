...
<head>
    ...
    <title>MyAchievements - Reset Password</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    @if(isset($user))
                                    <form class="user" action="{{ route('resetpassword.reset', ['user' => $user->id]) }}" method="POST">
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12 mb-3 mb-sm-0">
                                                ...
                                                is-invalid @enderror" name="new_password" id="new_password" placeholder="New Password" required autofocus>
                                                <span class="bi bi-eye-slash-fill p-1 text-center" id="togglePassword" style="position: absolute; right:25px; top: 5px; background-color:white;"></span>
                                                @error('new_password')
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                ...
                                                is-invalid @enderror" name="new_password_confirmation" id="new_password_confirmation" placeholder="Confirm New Password" required>
                                                <span class="bi bi-eye-slash-fill p-1 text-center" id="toggleRePassword" style="position: absolute; right:25px; top: 5px; background-color:white;"></span>
