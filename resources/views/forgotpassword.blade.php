                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">Just enter your email below, 
                                            then reset your password!</p>
                                    </div>
                                    <form class="user" action="{{ route('forgotpassword.validation') }}" method="POST">
                                        @csrf
                                        <div class="form-group">
                                            <input type="email" class="form-control @error('email')
                                            is-invalid @enderror" id="email" name="email" placeholder="Email Address" required autofocus>
                                            @error('email')
